        ...
        <div class="intro">
          ...
          <div class="intro-text left-0 text-center bg-faded p-5 rounded">
            <h2 class="section-heading mb-4">
              <span class="section-heading-upper">Auti kafé</span>
              <span class="section-heading-lower">Spellen</span>
            </h2>
            <p class="mb-3">In het Auti Kafé wordt regelmatig een avond georganiseerd voor jongeren met autisme (ASS) tussen de 13 en 25 jaar.
              <br/>
              <br/>
              Gezellig uitgaan om anderen te ontmoeten, te dansen, spelletjes te doen, te kletsen, muziek te luisteren, een drankje te drinken of gewoon te chillen. Bij het Auti Kafé kan dit in een rustige omgeving en mág je mee doen aan activiteiten, maar het hoeft niet!
            </p>
            <div class="intro-button mx-auto">
              <a class="btn btn-primary btn-xl" href="/location/">Bezoek ons vandaag</a>
            </div>
          </div>
        </div>
      </div>
